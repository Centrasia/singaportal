...
$mailTo[0] = 'info@singaportal.net';
$mailTo[1] = '';
$mailTo[2] = '';

// 受け取る時のSubject（件名）
$mailSubject = 'シンガポータル現地GMスカイプ面談依頼フォームより送信されました';

// 自動返信のSubject（件名）
$replySubject = '(自動返信)【 シンガポータル 】現地GMとのスカイプ面談にご依頼いただきありがとうございます。';
...
// 自動返信時の送信元メールアドレス
$replyAddress = 'info@singaportal.net';

// 自動返信時の送信元メールアドレスに付加する名前
$replyName = 'シンガポータル｜CENTRASIA PARTNERS Japan Branch';
